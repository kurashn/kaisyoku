...
export default function AboutPage() {
 ...
 <h2 className="text-3xl font-serif font-bold mt-2 text-navy-950">なぜ「会食」に<br className="md:hidden"/>特化するのか</h2>
 </div>
 <div className="mx-auto max-w-3xl text-lg text-navy-700">
 ...
 Kaisyokuは、そんな「不確実性」を排除するために生まれました。私たちは味だけでなく、「環境」と「リスク管理」を徹底的に審査し、
 ...
 <section id="standard"className="bg-slate-50 py-20 scroll-mt-20">
 ...
 <div className="absolute -top-8 left-6 flex h-16 w-16 items-center justify-center rounded-full bg-main text-white shadow-lg border-4 border-slate-50">
 <item.icon className="h-8 w-8"/>
 </div>
 <h3 className="text-xl font-bold mb-3 flex items-center gap-2 text-navy-950">
 ...
 <div className="max-w-5xl mx-auto bg-navy-50 rounded-2xl p-8 md:p-12 border border-navy-100">
 ...
 <span className="font-bold text-navy-800">{txt}</span>
 </div>
 ))}
 </div>
 </div>
 ...
 <div className="relative bg-white p-6 rounded-xl shadow-lg border border-navy-100">
 {/* Mock UI of App's Allergy Check */}
 <div className="border-b border-gray-100 pb-4 mb-4">
 <p className="text-xs text-gray-400">事前確認フォーム</p>
 <p className="font-bold text-navy-900">田中 誠司 様へのご質問</p>
 </div>
