...
export default async function ArticlesPage() {
 ...
 <span className="text-navy-700 font-medium">記事一覧</span>
 </div>
 </div>
 </div>
 ...
 <h1 className="font-serif text-3xl font-bold text-navy-950 mt-2">
 すべての記事
 </h1>
 ...
 <button className="flex h-10 w-10 items-center justify-center rounded-lg bg-white text-navy-600 hover:bg-navy-50 font-medium transition-colors">2</button>
 <button className="flex h-10 w-10 items-center justify-center rounded-lg bg-white text-navy-600 hover:bg-navy-50 font-medium transition-colors">3</button>
 </div>
 </main>
