...
export default async function CategoryPage({ params }: { params: Params }) {
 ...
 <div className="mb-8">
 <Link href="/"className="inline-flex items-center text-sm text-navy-600 hover:text-navy-900 mb-4">
 <ArrowLeft className="mr-2 h-4 w-4"/>
 トップに戻る
 </Link>
 <h1 className="text-3xl font-bold text-navy-950">
 {categoryName}
 <span className="ml-4 text-sm font-normal text-navy-600">の記事一覧</span>
 </h1>
 </div>
